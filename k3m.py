...
phase5_lookup = {7, 14, 15, 28, 30, 31, 56, 60, 62, 63, 112, 120, 124, 126, 131, 135, 143, 159, 191, 193, 195, 199, 207, 224, 225, 227, 231, 239, 240, 241, 243, 248, 249, 251, 252, 254, 253, 247, 223, 127}
...
image = image*255
cv2.imshow("image", image)
cv2.imwrite(name[:-4]+"_k3m.png", image)
cv2.waitKey(2000)
